...
class AWSPersistor(Persistor):
    ...
    def _persist_tar(self, file_key: Text, tar_path: Text) -> None:
        ...
        self.persist_file(file_key, tar_path)
    ...
    def persist_file(
        ...
        with open(file_path, "rb") as f:
            self.s3.Object(self.bucket_name, file_key).put(Body=f, **put_kwargs)
...
class GCSPersistor(Persistor):
    ...
    def persist_file(
        ...
        blob.upload_from_filename(file_path, **upload_kwargs)
...
class AzurePersistor(Persistor):
    ...
    def __init__(
        ...
        self.account_url = _azure_account_url(azure_account_name, endpoint_url)
    ...
    def persist_file(
        ...
        with open(file_path, "rb") as data:
            self._container_client().upload_blob(
                name=file_key, data=data, **upload_kwargs
            )
...
def _azure_account_url(
    azure_account_name: Text, endpoint_url: Optional[Text] = None
) -> Text:
    """Return the Azure Blob account URL, optionally for an emulator."""
    if endpoint_url:
        return endpoint_url.rstrip("/") + "/"
    return f"https://{azure_account_name}.blob.core.windows.net/"
