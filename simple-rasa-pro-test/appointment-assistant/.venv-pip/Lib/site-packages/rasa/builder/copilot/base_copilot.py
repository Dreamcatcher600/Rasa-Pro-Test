...
from rasa.builder.copilot import tracker_context_formatting
...
class BaseCopilot(ABC):
    ...
    def _format_conversation_history(tracker_context: Optional[TrackerContext]) -> str:
        ...
        return tracker_context_formatting.format_conversation_history(tracker_context)
    ...
    def _format_current_state(tracker_context: Optional[TrackerContext]) -> str:
        ...
        """
        return tracker_context_formatting.format_current_state(tracker_context)
    ...
    def _format_tracker_event_attachments(events: List[EventContent]) -> Optional[str]:
        ...
        return tracker_context_formatting.format_tracker_event_attachments(events)
