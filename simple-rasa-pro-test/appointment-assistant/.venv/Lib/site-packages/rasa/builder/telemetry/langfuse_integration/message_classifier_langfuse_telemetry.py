...
class MessageClassifierLangfuseTelemetry:
    ...
    def trace_classification(
        ...
        @wraps(func)
        async def wrapper(
            self: "MessageClassifier", request: "ClassificationRequest"
        ) -> "MessageClassifierResult":
            langfuse_client = langfuse.get_client()

            # The final turn is the user message being classified.
            user_message_text = request.turns[-1].content if request.turns else ""
