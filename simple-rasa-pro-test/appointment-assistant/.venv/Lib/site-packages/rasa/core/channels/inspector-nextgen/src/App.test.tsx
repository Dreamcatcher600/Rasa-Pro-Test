...
describe("App (standalone)", () => {
  ...
  describe("httpAuth", () => {
    it("initializes store with a query-transport credential from URL search params", () => {
    ...
    it("leaves httpAuth undefined when token is not in URL", () => {
      render(<App />);
